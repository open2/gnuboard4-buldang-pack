...
ALTER TABLE `$g4[board_table]` CHANGE `bo_order_search` `bo_order` INT( 11 ) NOT NULL DEFAULT '0' ;
...
ALTER TABLE `$g4[member_table]` add `mb_hp_certify` tinyint(4) NOT NULL default '0';
ALTER TABLE `$g4[member_table]` add `mb_adult` tinyint(4) NOT NULL default '0';

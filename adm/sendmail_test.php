...
if ($mail) {
    ...
    $from_name  = "$config[cf_title] - 메일검사";
...
<div class="panel-body">
    ...
    <p>받는 메일주소 : <input type=text class="form-control" name=mail size=40 required itemname="E-mail" value="<?=$config[cf_admin_email]?>">
    <p>
    <input type=submit value="  발  송  " class="btn btn-default">
    </form>
</div>
</div>

...
$menu["menu100"] = array (
    array("100000", "환경설정", ""),
    array("100100", "기본환경설정", "$g4[admin_path]/config_form.php"),
    array("100110", "관리권한설정", "$g4[admin_path]/auth_list.php"),
    array("-"),
    ...
    array("100440", "gd_info()", "$g4[admin_path]/gd_info.php"),
    array("-"),
    array("100700", "복구/최적화", "$g4[admin_path]/repair.php"),
    array("100710", "DB 최적화", "$g4[admin_path]/optimize.php"),
    array("100720", "세션파일 삭제", "$g4[admin_path]/session_delete.php"),
    array("-"),

...
<tr>
    <td>키워드 (Keywords)</td>
    <td>
    <input type=text class=ed name='cf_meta_keywords' value='<?=$config[cf_meta_keywords]?>' size=100>
...
<tr>
    <td>플래쉬 업로드 확장자</td>
    <td><input type=text class=ed name='cf_flash_extension' size='80' itemname='플래쉬 업로드 확장자' value='<?=$config[cf_flash_extension]?>'>
        <?=help("게시판 글작성시 플래쉬 파일 업로드 가능 확장자. | 로 구분")?></td>
</tr>
<tr>
    <td>동영상 업로드 확장자</td>
    <td><input type=text class=ed name='cf_movie_extension' size='80' itemname='동영상 업로드 확장자' value='<?=$config[cf_movie_extension]?>'>
        <?=help("게시판 글작성시 동영상 파일 업로드 가능 확장자. | 로 구분")?></td>
</tr>
<tr>
    <td>단어 필터링
        <?=help("입력된 단어가 포함된 내용은 게시할 수 없습니다.\n\n단어와 단어 사이는 ,로 구분합니다.")?></td>
    <td><textarea class=ed name='cf_filter' rows='7' style='width:99%;word-break:break-all;'><?=$config[cf_filter]?> </textarea></td>
</tr>
...
<tr>
    <td>회원가입약관</td>
    <td valign=top><textarea class=ed name='cf_stipulation' rows='10' style='width:99%;'><?=$config[cf_stipulation]?> </textarea></td>
</tr>
<tr>
    <td>개인정보취급방침</td>
    <td valign=top><textarea class=ed name='cf_privacy' rows='10' style='width:99%;'><?=$config[cf_privacy]?> </textarea></td>
</tr>
<tr>
    <td>수집하는 개인정보의 <br>항목</td>
    <td valign=top><textarea class=ed name='cf_privacy_1' rows='5' style='width:99%;'><?=$config[cf_privacy_1]?> </textarea></td>
</tr>
<tr>
    <td>개인정보의 <br>수집 및 이용 목적</td>
    <td valign=top><textarea class=ed name='cf_privacy_2' rows='5' style='width:99%;'><?=$config[cf_privacy_2]?> </textarea></td>
</tr>
<tr>
    <td>개인정보의 <br>보유 및 이용기간</td>
    <td valign=top><textarea class=ed name='cf_privacy_3' rows='5' style='width:99%;'><?=$config[cf_privacy_3]?> </textarea></td>
</tr>
<tr>
    <td>개인정보의 제3자제공<br>※내용이 있으면 동의버튼이 출력됩니다</td>
    <td valign=top><textarea class=ed name='cf_privacy_4' rows='5' style='width:99%;'><?=$config[cf_privacy_4]?> </textarea></td>
</tr>
<tr>
    <td>개인정보의 취급위탁<br>※필수 업무이외의 취급위탁을 하는 경우는 동의버튼을 별도로 만들어야 합니다.</td>
    <td valign=top><textarea class=ed name='cf_privacy_5' rows='5' style='width:99%;'><?=$config[cf_privacy_5]?> </textarea></td>
</tr>
...
<tr>
    ...
    <td><textarea class=ed name='cf_hp_certify_message' rows='5' style='width:99%;'><?=$config[cf_hp_certify_message]?> </textarea>
    <BR>(예: 불당의 Opencode\n\n$certify_number\n인증번호 입니다. )
    </td>
</tr>
<tr>
    <td>발신자 전화번호</td>
    <td><input type=text class=ed name='cf_hp_certify_return' size='16' itemname='발신자 전화번호' value='<?=$config[cf_hp_certify_return]?>'> (예: 01012341234)</td>
</tr>
...
<tr>
    ...
    <td><input type='text' class=ed style='width:99%;' name=cf_<?=$i?> value='<?=$config["cf_$i"]?>' title='여분필드 <?=$i?> 설정값'>
    <input type=text class=ed name='cf_<?=$k?>_subj' value='<?=get_text($config["cf_{$k}_subj"])?>' title='여분필드 <?=$k?> 제목' style='text-align:right;font-weight:bold;' size=15>

...
<form name=fbannergroup method=post onsubmit="return fbannergroup_check(this);" autocomplete="off" role="form" class="form-inline">
...
<p align=center>
    ...
    <input type=button class="btn btn-default" value='  목  록  ' onclick="document.location.href='./banner_group_list.php?<?=$qstr?>';">
</form>
